...
sudo cp ./mod_harbour/linux/"Ubuntu 18.04"/20190524/mod_harbour.so /usr/lib/apache2/modules
sudo cp ./mod_harbour/linux/"Ubuntu 18.04"/20190524/libharbour.so.3.2.0 /var/www/html
