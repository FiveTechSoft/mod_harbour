  ...
  <div class="container-fluid">
             ...
             <?prg local cRows := "", n
                   for n = 1 to FCount()
                      ...
                      cRows += '   <td class="center"><input type="text" class="form-control" style="border-radius:0px"' + ;
                                   " value='" + mh_valToStr( FieldGet( n ) ) + "'></td>"
                      cRows += '</tr>'
                   next
                   return cRows?>
          </tbody>
    ...
    <div class="panel-default" style="margin:20px">
       <div class="btn-group">
          ...
          <a class="btn btn-default" href="dbedit.prg?prev:<?prg return hb_ntos( RecNo() ) ?>"><span>Prev</span></a>
          <a class="btn btn-default" href="dbedit.prg?next:<?prg return hb_ntos( RecNo() ) ?>"><span>Next</span></a>
   ...
   ? "Alias: ", alias(), " - Num de work area: ",  select()
