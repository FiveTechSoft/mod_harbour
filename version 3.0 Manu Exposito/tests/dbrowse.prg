          ...
          <tbody>
             <?prg local cRow := "", nRow := 1, n
                   while nRow < 11 .and. ! Eof()
                      cRow += '<tr>'
                      for n = 1 to FCount()
                         cRow += '<td class="center">' + mh_valToStr( FieldGet( n ) ) + "</td>"
                      next
                      cRow += "<td>"
          ...
          <div class="col-xs-6">
             <div class="dataTables_paginate paging_bootstrap">
                <ul class="pagination pagination-sm" style="margin:0 !important">
                   <li class="prev"><a href="dbrowse.prg?prev:<?prg return hb_ntos( RecNo() - 10 ) ?>">Previous</a></li>
                   <li class="active"><a href="#">1</a></li>
                   <li><a href="#">2</a></li>
                   <li><a href="#">3</a></li>
                   <li><a href="#">4</a></li>
                   <li class="next"><a href="dbrowse.prg?next:<?prg return hb_ntos( RecNo() ) ?>">Next</a></li></ul>
             </div>
          </div>
          <div class="btn-group">
